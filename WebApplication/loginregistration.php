...
<body>
 ...
 -->
		 ...
		 <form action="connectsignup.php" method="post"  id="signup" class="input-group">
		 	...
		 	<input type="password" class="input-field" name="confirm_password" placeholder="Confirm Password" required><br><br>
		 	<input type="radio" id="usertype" name="Client" value="Client">
